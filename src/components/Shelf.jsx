      ...
      <div className="flex flex-row gap-4 items-center justify-start max-w-screen-md overflow-x-auto whitespace-nowrap pb-2 px-2">
        <RoundedPanel bgcolor={'bg-blue-400'}>
          <div className="flex flex-row items-center justify-between gap-4">
            ...
            <p className="flex flex-col text-slate-700">Supplies<span className="font-bold text-lg text-slate-800">4,334</span></p>
          </div>
        </RoundedPanel>
        <RoundedPanel bgcolor={'bg-emerald-400'}>
          <div className="flex flex-row items-center justify-between gap-4">
            <LuShoppingBag size={'2em'}/>
            <p className="flex flex-col text-slate-700">Categories<span className="font-bold text-lg text-slate-800">15</span></p>
          </div>
        </RoundedPanel>
        <RoundedPanel bgcolor={'bg-red-400'}>
          <div className="flex flex-row items-center justify-between gap-4">
            <LuShoppingBag size={'2em'}/>
            <p className="flex flex-col text-slate-700">Users<span className="font-bold text-lg text-slate-800">7</span></p>
          </div>
        </RoundedPanel>
